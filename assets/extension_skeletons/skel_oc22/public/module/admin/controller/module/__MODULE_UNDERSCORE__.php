...
// 		$this->model_module___MODULE_UNDERSCORE__->install();
		
	}
	
	public function index() {
		
	    $module_route = 'module/__MODULE_UNDERSCORE__';
		...
		$this->response->setOutput($this->load->view('module/__MODULE_UNDERSCORE__.tpl', $data));
	}
