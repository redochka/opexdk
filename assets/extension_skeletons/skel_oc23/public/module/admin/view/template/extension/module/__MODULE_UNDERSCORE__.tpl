        ...
        <div class="panel-body">
          ...
          <form action="<?php echo $action; ?>" id="tv-module-form" method="post" enctype="multipart/form-data" class="form-horizontal">
            ...
            <div class="form-group">
              <label class="col-sm-3 control-label" for="__MODULE_UNDERSCORE___cfg_log"><span data-toggle="tooltip" title="Verbose logs will be printed to the opencart log file. Useful when you need to figure out what is going on.">Enable __DISPLAY_NAME__ logs:</span></label>
              <div class="col-sm-9">
                  <div class="radio">
